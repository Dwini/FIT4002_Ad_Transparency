...
4. Get updated AWS credentials from [here](https://labs.vocareum.com/main/main.php). These credentials get updated frequently (daily?).
...
## Updating containers.
1. Get updated AWS credentials from [here](https://labs.vocareum.com/main/main.php) and Update the local AWS credentials file with the credentials found. On Windows, the local file is saved `C:\Users\<USERNAME>\.aws`.
